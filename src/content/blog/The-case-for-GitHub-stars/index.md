...
**Researchers at Aristotle University of Thessaloniki [built a machine](https://ieeexplore.ieee.org/document/7589790/) to see if it could predict GitHub stars using nothing but code metrics.** To move past the "vanity" debate, a quality estimation system was developed to transform raw source code into quantified quality scores. By analyzing **24,930 Java source files** from the top 100 repositories, the system proved that "developer-perceived quality" (stars) correlates directly with structural code characteristics.
